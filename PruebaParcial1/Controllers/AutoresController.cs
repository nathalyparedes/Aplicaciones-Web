...
namespace PruebaParcial1.Controllers
{
    ...
    public class AutoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AutorId,Nombre,Apellido,FechaNacimiento,Nacionalidad")] Autores autores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AutorId,Nombre,Apellido,FechaNacimiento,Nacionalidad")] Autores autores)
        {
